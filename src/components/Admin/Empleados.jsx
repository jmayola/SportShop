      ...
      <section className="flex justify-center my-5">
        <div className="flex flex-col w-2/3 border border-gray-300 shadow-md p-8">
          <div className="flex justify-center gap-x-5">
            ...
            />
            <select
              className="block rounded-lg w-1/2 text-center border border-gray-300 px-2 py-2 shadow-sm outline-none placeholder:text-gray-400 focus:ring-1 focus:ring-black"
              name=""
          ...
          <div className="flex justify-between w-full p-5">
            ...
            <div method="post" action="" className="w-full py-3">
              <div className="flex flex-col gap-y-2">
                <div>
                  <h2 className="flex justify-start px-2">Nombre y Apellido</h2>
                  <input
                    name="fullname"
                    type="text"
