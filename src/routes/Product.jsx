      ...
      <Header></Header>
        <div className='grid grid-cols-2 m-auto w-2/3 h-2/3 border max-xl:grid-cols-1  border-gray-300'>
          <div className=' flex justify-center w-fit m-auto'>
            <img src={"../"+Data[id].image_products} className='w-96 min-h-[200px]  border-gray-300 object-contain' alt="" />
          </div>
          ...
          <h3 className='p-5 bg-gray-300 rounded-md'>{Data[id].desc_products}</h3>
          <div className='flex align-middle justify-between rounded-md bg-gray-300 p-5'>
          <h3 className='text-right justify-end text-4xl'>${Data[id].price_products}</h3>
          <input type='number' readOnly defaultValue={0} className='rounded-md w-1/3 text-center text-4xl'/>
          <button className='p-5 bg-orange-500 rounded-md font-medium text-white'>Comprar</button>
          </div>
          </div>
        </div>     
      <Footer></Footer>
